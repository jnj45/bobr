...
//	var url = "/com/sym/cal/EgovAdministCalPopup.do";
...
function fn_egov_NormalCalendar(frm, sDate, vDate) {
	...
	var url = frm.cal_url.value;
//	var url = "/com/sym/cal/EgovNormalCalPopup.do";
	...
	if( sAppName.indexOf("Netscape") > -1){
		openParam = "dialogWidth:337px;dialogHeight:344px;scroll:no;status:no;center:yes;resizable:yes;";
	}else if(sAppName.indexOf("Microsoft") > -1){
		openParam = "dialogWidth:320px;dialogHeight:344px;scroll:no;status:no;center:yes;resizable:yes;";
	}else{
		openParam = "dialogWidth:320px;dialogHeight:344px;scroll:no;status:no;center:yes;resizable:yes;";
	}
...
function fn_egov_Calendar(frm, sDate, vDate) {
	...
	var url = frm.cal_url.value;
//	var url = "/com/sym/cal/callCalPopup.do";
