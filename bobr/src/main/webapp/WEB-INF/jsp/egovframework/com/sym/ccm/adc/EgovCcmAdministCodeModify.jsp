  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <input  name="upperAdministZoneNm" size="60" maxlength="60" value="${administCode.upperAdministZoneNm}" readonly onClick="javascript:fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm)" title="상위행정구역코드"/>
		<a href="#noscript" onclick="fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />" alt="행정코드찾기"></a>
