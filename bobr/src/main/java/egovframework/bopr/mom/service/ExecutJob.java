 ...
 * </pre>
 */
public class ExecutJob extends ComDefaultVO{
	/**
	 * serialVersionUID
	 */
	...
	/**
	 * executJob attribute 를 리턴한다.
	 * @return ExecutJob
	 */
	public ExecutJob getEgovExecutJob() {
		return executJob;
	}
	/**
	 * executJob attribute 값을 설정한다.
	 * @param ExecutJob 
	 */
	public void setEgovExecutJob(ExecutJob executJob) {
		this.executJob = executJob;
	}
	/**
